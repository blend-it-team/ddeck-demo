...
ddeck-demo theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of ddeck-demo theme and run the following commands:
`nvm use`
...
`drush en ddeck-demo -y`
`drush config-set system.theme default ddeck-demo -y`
